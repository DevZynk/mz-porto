...
export default function RelatedBlogs({ relatedBlogs, locale }: RelatedBlogsProps) {
    ...
    <div className="pt-12 border-t border-border/40">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {relatedBlogs.map((blog) => {
          const blogImg = blog.meta?.metaImage as Media | undefined
          return (
            <div
              key={blog.id}
